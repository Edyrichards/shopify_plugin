...
const connection = process.env.NODE_ENV === 'test' ? undefined : redisClient.duplicate();

export const indexQueue = process.env.NODE_ENV === 'test'
  ? { add: async () => {} }
  : new Queue('product-index', { connection });
